...
# from GroovyRobot.modules.sql import warns_sql as warnssql
import GroovyRobot.modules.sql.blacklist_sql as blacklistsql

# from GroovyRobot.modules.sql import cust_filters_sql as filtersql
# import GroovyRobot.modules.sql.welcome_sql as welcsql
import GroovyRobot.modules.sql.locks_sql as locksql
import GroovyRobot.modules.sql.notes_sql as sql

# from GroovyRobot.modules.rules import get_rules
import GroovyRobot.modules.sql.rules_sql as rulessql
from GroovyRobot import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from GroovyRobot.__main__ import DATA_IMPORT
from GroovyRobot.modules.connection import connected
from GroovyRobot.modules.helper_funcs.alternate import typing_action
from GroovyRobot.modules.helper_funcs.chat_status import user_admin
from GroovyRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("GroovyRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("GroovyRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `GroovyRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("GroovyRobot{}.backup".format(chat_id))  # Cleaning file
