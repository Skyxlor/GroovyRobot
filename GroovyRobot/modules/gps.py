...
@Groovy.on_message(filters.command(["gps"]))
...
#     await message.delete()
    ...
    try:
        ...
        ---------telegram : @M3_4_U-----
        """
        geolocator = Nominatim(user_agent="legend-Groovy")
#         zoom=[0-18]
...
@Groovy.on_message(filters.command(["distance"]))
...
# Groovy.add_handler(MessageHandler(gps))     
# Groovy.add_handler(MessageHandler(distance))
