...
from GroovyRobot.modules.nightmode import button_row
from GroovyRobot import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
from GroovyRobot.events import register
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./GroovyRobot/resources/fonts/UrbanJungleDEMO.otf")
