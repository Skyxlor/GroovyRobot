...
from GroovyRobot import OWNER_ID, pbot
from GroovyRobot.utils.admins import can_change_info
from GroovyRobot.utils.errors import capture_err
from GroovyRobot.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote =r"^(\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤️|💘|cool|good|\👍|baby|groovy|thank you|gud|thankyou|love|pro)$"
