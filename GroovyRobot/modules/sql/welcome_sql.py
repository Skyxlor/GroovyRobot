...
from GroovyRobot.modules.helper_funcs.msg_types import Types
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "It's dangerous to go groovy, take {first}!",
...
DEFAULT_GOODBYE_MESSAGES = [
    ...
    "Please don't leave me groovy in this place, {first}!",
