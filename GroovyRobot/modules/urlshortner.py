...
@groovy.on_message(filters.command(["short"]))
...
@groovy.on_message(filters.command(["unshort"]))
...
# groovy.add_handler(MessageHandler(short_urls))
# groovy.add_handler(MessageHandler(unshort))
__help__ = """
ᴍᴀᴋᴇ sʜᴏʀᴛs ᴏғ ᴀ ɢɪᴠᴇɴ ʟɪɴᴋ 
 ❍ /short <url>  *:Example `/short https://t.me/groovysupportt`.
 *"""
