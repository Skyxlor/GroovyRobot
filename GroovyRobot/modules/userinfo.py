...
from GroovyRobot.modules.alive import Groovy
import GroovyRobot.modules.sql.userinfo_sql as sql
...
from GroovyRobot.__main__ import STATS, TOKEN, USER_INFO
from GroovyRobot.modules.disable import DisableAbleCommandHandler
from GroovyRobot.modules.helper_funcs.chat_status import sudo_plus
from GroovyRobot.modules.helper_funcs.extraction import extract_user
from GroovyRobot.modules.sql.global_bans_sql import is_user_gbanned
from GroovyRobot.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/groovysupportt">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url=f"https://t.me/groovysupportt"
                            ),
                            InlineKeyboardButton(
                                "Dɪsᴀsᴛᴇʀ", url="https://t.me/groovysupportt"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
            ...
            message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/groovysupportt"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪsᴀsᴛᴇʀ", url="https://t.me/groovysupportt"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
